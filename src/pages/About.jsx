  ...
  return (
    <div className="my-12">
      <div className="container">
        ...
        <p className="mt-6 w-10/12 mx-auto md:w-9/12 lg:w-8/12  text-xl text-center leading-8 tracking-wide">
      ...
      <div className="container">
        ...
        <p className="w-5/6 mx-auto text-center mt-3 text-lg">
        ...
        <div className="bg-white p-5 my-8">
          <div className="w-10/12 mx-auto my-6">
            <h3 className="text-3xl text-dodge-blue font-bold">Our Story</h3>
            <p className="my-5 text-xl tracking-wide font-light">
