    ...
    return (
        ...
        >
            ...
            <Swiper
                ...
                className="w-screen sm:px-10 sm:mx-0 md:mx-10 lg:mx-24 bg-black bg-opacity-70"
            >
                <SwiperSlide>
                    <div className="md:container mx-auto min-h-[400px] p-4 sm:px-10 md:pl-24 w-full bg-[#0b416c] md:bg-inherit md:h-[70vh] grid md:place-content-center ">
                        ...
                        <p className="text-slate-100 md:w-4/6 text-lg font-light my-4">
                            We are grateful that you have visited our website
                            and hope that you might choose to encounter God with
                            us in our celebrations of sacred liturgies and in
                            our ministries. Whether you are visiting us for the
                            first time, returning to the practice of your
                            Catholic faith or looking to learn more about Dekut
                            Catholic Chaplaincy, please know that we are happy
                            to have you here.
                        </p>
                        <Link
                            to="/about"
